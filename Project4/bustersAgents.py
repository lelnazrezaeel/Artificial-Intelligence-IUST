...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for ghostDistribution in livingGhostPositionDistributions:
            maxBeliefsForGhosts.append(max(ghostDistribution, key = lambda x : ghostDistribution[x]))
        ...
        for action in legal:
            ...
            distances = [self.distancer.getDistance(successor, ghost) for ghost in maxBeliefsForGhosts]
            actionBestValue = min(distances)
            if bestValue > actionBestValue:
                bestAct = action
                bestValue = actionBestValue
